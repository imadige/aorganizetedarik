				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<?php echo $form->textField($model,'username',array('size'=>45,'class' => 'form-control col-md-7 col-xs-12')); ?>
						...
						<div class="form-group">
							<?php echo $form->labelEx($model,'birthday',array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<?php echo $form->textField($model,'birthday',array('class' => 'date-picker form-control col-md-7 col-xs-12','id' => 'birthday')); ?>
