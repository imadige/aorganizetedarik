        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main">
                ...
                <header class="page-header">
                    <h1 class="page-title">Basamak Bilişim Ürünleri</h1>
                                    ...
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            ...
                                            <div class="product-thumbnail">
                                                ...
                                                <img data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/1.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                    ...
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            ...
                                            <div class="product-thumbnail">
                                                ...
                                                <img data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/3.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                    ...
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            ...
                                            <div class="product-thumbnail">
                                                ...
                                                <img data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/6.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                ...
                                <div class="product-outer">
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                            <div class="product-thumbnail">
                                                <img class="wp-post-image" data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/2.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                            </div>
                                ...
                                <div class="product-outer">
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                            <div class="product-thumbnail">
                                                <img class="wp-post-image" data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/3.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                            </div>
                                ...
                                <div class="product-outer">
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                            <div class="product-thumbnail">
                                                <img class="wp-post-image" data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/4.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                            </div>
                                ...
                                <div class="product-outer">
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                            <div class="product-thumbnail">
                                                <img class="wp-post-image" data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/5.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                            </div>
                                ...
                                <div class="product-outer">
                                    <div class="product-inner">
                                        ...
                                        <a href="single-product.html">
                                            <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                            <div class="product-thumbnail">
                                                <img class="wp-post-image" data-echo="<?=Yii::app()->request->baseUrl;?>/front/images/products/6.jpg" src="<?=Yii::app()->request->baseUrl;?>/front/images/blank.gif" alt="">
                                            </div>
            ...
            <aside class="widget widget_electro_products_filter">
                <div style="border: 1px solid #e5e5e5;padding: 20px;">
                    <div class="magazalogo">
                        <img class="center-block img-responsive" src="<?=Yii::app()->request->baseUrl;?>/front/images/basamak-logo.gif" alt="">
                    </div>
                    <hr>
                    <div class="magazatitle">
                        Basamak Bilişim <i class="fa fa-mobile" aria-hidden="true"></i> <i class="fa fa-home" aria-hidden="true"></i>

                    </div>
                    <hr>

                    <a class="btn btn-default fixbuton" href="<?=Yii::app()->createUrl('profile/profile');?>"><i class="fa fa-user" aria-hidden="true"></i>Mağaza Profili</a>
